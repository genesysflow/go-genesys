...
## The Basics
- [Routing](routing.md) — routes, groups, middleware groups, model binding
- [Validation](validation.md) — form requests and 422 responses
- [Views](views.md) — templates, layouts, partials
- [Sessions](sessions.md) — drivers, flash data, old input
- [Error Handling](errors.md) — HTTP errors, debug pages, reporting
